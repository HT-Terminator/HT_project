...
position_pid Speedl;         //速度
position_pid Speedr;         //速度
...
{
    //速度
    Speedl.kp=3.5;//0.25 0.3 0.375 0.8
    Speedl.ki=1;
    Speedl.kd=0;
    Speedl.target_value=40;//57 58
    Speedl.output=0;
    Speedl.output_last=0;
    Speedl.output_Max=2000;//300
    Speedl.output_Min=0;
	
	  Speedr.kp=3.5;
    Speedr.ki=1;
    Speedr.kd=0;
    Speedr.target_value=40;
    Speedr.output=0;
    Speedr.output_last=0;
    Speedr.output_Max=2000;
    Speedr.output_Min=0;
...
{
		left_pid_control_output = 451679 / left_pid_control_output;
