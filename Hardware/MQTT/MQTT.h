...
#define  MQTT_TxData(x)       u2_TxData(x)                                  //串口2负责云端的数据发送


/*需要根据云端的信息而改动，这里我会先改好就可直接使用*/
#define  PRODUCTKEY           "a1lRYtbdqza"                                 //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                            //产品ID长度
#define  DEVICENAME           "LAOLAO"                                        //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                            //设备名长度
#define  DEVICESECRE          "89877f5f2c421365aa6644c824d06eba"            //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                           //设备秘钥长度
#define  S_TOPIC_NAME         "/sys/a1lRYtbdqza/LAOLAO/thing/service/property/set"   //需要订阅的主题  
#define  P_TOPIC_NAME         "/sys/a1lRYtbdqza/LAOLAO/thing/event/property/post"    //需要发布的主题     
