...
#define HX711_SCK_HIGH_1() 	GPIO_SetOutBits(HT_GPIOB, GPIO_PIN_0)		// GPIO = HIGH	// PB0
#define HX711_SCK_LOW_1() 	GPIO_ClearOutBits(HT_GPIOB, GPIO_PIN_0)		// GPIO = LOW	// PB0
#define HX711_DOUT_HIGH_1()	GPIO_SetOutBits(HT_GPIOB, GPIO_PIN_1)		// GPIO = HIGH	// PB1
#define HX711_DOUT_LOW_1() 	GPIO_ClearOutBits(HT_GPIOB, GPIO_PIN_1)		// GPIO = LOW	// PB1
#define HX711_DOUT_1		GPIO_ReadInBit(HT_GPIOB, GPIO_PIN_1)
